/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ec776e7175a6b37055c681dc98ce7628)
// Runtime types generated with workerd@1.20260421.1 2026-04-24 nodejs_compat
declare namespace Cloudflare {
	interface DevelopmentEnv {
		PUBLIC_TURNSTILE: "1x00000000000000000000AA";
		SECRET_TURNSTILE: string;
	}
	interface ProductionEnv {
		PUBLIC_TURNSTILE: "0x4AAAAAAAc02UX-EFdbhc0N";
		SECRET_TURNSTILE: string;
	}
	interface Env {
		PUBLIC_TURNSTILE: "1x00000000000000000000AA" | "0x4AAAAAAAc02UX-EFdbhc0N";
		SECRET_TURNSTILE: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_TURNSTILE" | "SECRET_TURNSTILE">> {}
}
