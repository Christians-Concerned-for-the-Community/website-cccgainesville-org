/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 464157f7e5510ee3b0fbd696930fe63e)
// Runtime types generated with workerd@1.20260520.1 2026-05-18 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_GOATCOUNTER_ENDPOINT: "https://staging-cccgainesville.goatcounter.com" | "https://cccgainesville.goatcounter.com";
	PUBLIC_CAPTCHA_NAME: "Turnstile";
	PUBLIC_CAPTCHA_KEY: "1x00000000000000000000AA" | "0x4AAAAAAAc02UX-EFdbhc0N";
	SECRET_CAPTCHA_KEY: string;
	SECRET_CONTACT_FORM_DEST: string;
	SECRET_GOATCOUNTER_KEY: string;
	SECRET_GOATCOUNTER_VIEWTOKEN: string;
	SECRET_GITHUB_ADMIN: string;
	SECRET_GITHUB_DIRECTOR: string;
	SECRET_GITHUB_OFFICE: string;
}
declare namespace Cloudflare {
	interface DevelopmentEnv {
		PUBLIC_GOATCOUNTER_ENDPOINT: "https://staging-cccgainesville.goatcounter.com";
		PUBLIC_CAPTCHA_NAME: "Turnstile";
		PUBLIC_CAPTCHA_KEY: "1x00000000000000000000AA";
		SECRET_CAPTCHA_KEY: string;
		SECRET_CONTACT_FORM_DEST: string;
		SECRET_GOATCOUNTER_KEY: string;
		SECRET_GOATCOUNTER_VIEWTOKEN: string;
	...
	interface ProductionEnv {
		PUBLIC_GOATCOUNTER_ENDPOINT: "https://cccgainesville.goatcounter.com";
		PUBLIC_CAPTCHA_NAME: "Turnstile";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_GOATCOUNTER_ENDPOINT" | "PUBLIC_CAPTCHA_NAME" | "PUBLIC_CAPTCHA_KEY" | "SECRET_CAPTCHA_KEY" | "SECRET_CONTACT_FORM_DEST" | "SECRET_GOATCOUNTER_KEY" | "SECRET_GOATCOUNTER_VIEWTOKEN" | "SECRET_GITHUB_ADMIN" | "SECRET_GITHUB_DIRECTOR" | "SECRET_GITHUB_OFFICE">> {}
}
